...
1 : Télécharger la [release](https://github.com/YohannDR/SudoEngine/releases) la plus récente dans (le .7z ou les 4 fichiers indépendamment) ou compiler le projet en Release, en bibliothèque de classes
